class RmqConfigWriter
  ...
  BAD_PASSWORD = "Password is not set. Please set a password."
  TEMPLATE = <<~END
  ...
  def self.do_render
    # Password presence check (no length restriction)
    raise BAD_PASSWORD if ADMIN_PASSWORD.nil? || ADMIN_PASSWORD.empty?
